...
In addition to the prerequisites mentioned [here](https://github.com/Ed-Fi-Alliance-OSS/Ed-Fi-DataImport/tree/main?tab=readme-ov-file#prerequisites), following requirements are additionaly needed to run Docker Deployment for Data Import:
